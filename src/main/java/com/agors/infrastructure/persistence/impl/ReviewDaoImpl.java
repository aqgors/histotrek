...
public class ReviewDaoImpl implements ReviewDao {
    ...
    public Review add(Review review) {
        ...
        try (Connection conn = ConnectionManager.getConnection();
            ...
            throw new RuntimeException("Error inserting review: " + review, e);
        }
        return review;
    }
    ...
    public List<Review> findByPlace(int placeId) {
        ...
        try (Connection conn = ConnectionManager.getConnection();
            ...
            throw new RuntimeException("Error fetching reviews for place " + placeId, e);
        }
        return list;
    }
    ...
    public List<Review> findByUser(int userId) {
        ...
        try (Connection conn = ConnectionManager.getConnection();
            ...
            throw new RuntimeException("Error fetching reviews for user " + userId, e);
        }
        return list;
    }
